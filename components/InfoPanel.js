...
import {AppRegistry ,StyleSheet, View, Environment, asset, Text, Image, Animated, VrButton } from "react-360";
...
console.log(this.props.displayInfoPanel)
    return (
      ...
      <View style={ this.props.displayInfoPanel ? styles.panel : styles.hidden}
      pointerEvents='none' >
          {
            img &&         
                <Image
...
const InfoPanelWithStore = connectToStores(
    InfoPanel, [TourStore], storeConnector
);
